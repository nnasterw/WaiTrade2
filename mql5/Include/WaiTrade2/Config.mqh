...
#define WT2_INPUT const
#else
#define WT2_INPUT input
#endif
...
input double InpBtcMinBodyPct = 0.0; // BTC profile 启用时 OB 实体最小占比 (0=跟随 InpMinOBBodyPct)
...
input int    InpBTCScanDepth    = 0;        // BTC profile OB 扫描深度 (0=跟随 InpOBScanDepth)
...
WT2_INPUT string InpXAUFageAltProfileSymbol = "XAU"; // 瑙﹀彂XAU alt profile鐨勫搧绉嶅悕鐗囨
WT2_INPUT string InpXAUFageAltProfileMonths = "10"; // 瑙﹀彂XAU alt profile鐨勬湀浠?
WT2_INPUT bool   InpXAUFageAltUseMonthFilter = false; // true=鍏佽鏈堜唤瑙﹀彂, false=浠呰嚜閫傚簲瑙﹀彂
WT2_INPUT int    InpXAUFageAltAdaptiveStartDay = 5; // 鏈堝唴绗琋澶╁悗鍏佽鑷€傚簲瑙﹀彂
WT2_INPUT double InpXAUFageAltAdaptiveMaxBalance = 230.0; // 浣欓浣庝簬璇ュ€艰Е鍙慳lt(0=绂佺敤)
WT2_INPUT double InpXAUFageAltAdaptiveMinPrice = 0.0; // 鑷€傚簲瑙﹀彂鏈€灏忎环鏍?0=涓嶉檺)
WT2_INPUT double InpXAUFageAltAdaptiveMaxPrice = 0.0; // 鑷€傚簲瑙﹀彂鏈€澶т环鏍?0=涓嶉檺)
WT2_INPUT string InpXAUAltContextFilter1Months = "10";
WT2_INPUT string InpXAUAltContextFilter1NoHours = "10,11";
WT2_INPUT double InpXAUAltContextFilter1Mult = 1.0;
WT2_INPUT double InpXAUAltContextFilter2MaxMonthStartBalance = 0.0;
WT2_INPUT string InpXAUAltContextFilter2Months = "";
WT2_INPUT double InpXAUAltContextFilter2Mult = 1.0;
WT2_INPUT string InpXAUAltContextFilter2NoHours = "";
WT2_INPUT double InpXAUAltContextFilter3MaxMonthStartBalance = 0.0;
WT2_INPUT string InpXAUAltContextFilter3Months = "";
WT2_INPUT double InpXAUAltContextFilter3Mult = 1.0;
WT2_INPUT string InpXAUAltContextFilter3NoHours = "";
WT2_INPUT double InpXAUAltContextFilter4MaxMonthStartBalance = 0.0;
WT2_INPUT string InpXAUAltContextFilter4Months = "";
